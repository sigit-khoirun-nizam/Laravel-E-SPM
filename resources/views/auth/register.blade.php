            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" action="/postregister" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_lengkap" id="nama_lengkap" placeholder="Nama Anda"/ value="{{old('nama_lengkap')}}">
                            </div>
                            @error('nama_lengkap')
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" id="pass" placeholder="Password Anda"/>
                            </div>
                            @error('password')
                                <div class="invalid-feedback " style="margin-top: -8%">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password2" id="re_pass" placeholder="Konfirmasi Password Anda"/>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="signup-image">
                        ...
                        <a href="/" class="signup-image-link">Saya Sudah Punya Akun</a>
                    </div>
                </div>
            </div>
        </section>
